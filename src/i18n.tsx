...
const translations: Record<Lang, Record<string, string>> = {
    en: {
        ...
        "about.p1": "We have been providing reliable transportation solutions to both locals and tourists for years. We understand that a car is more than just a vehicle; it's your key to exploring beautiful landscapes.",
        ...
        "why.title2": "Service in Your City",
        ...
        "why.feat5.desc": "We are locals who care about your experience.",
        ...
        // Footer
        "footer.desc": "Your reliable partner for car rentals. We provide high-quality vehicles and exceptional customer service 24/7.",
    ...
    fr: {
        ...
        "about.p1": "Nous fournissons des solutions de transport fiables aux habitants et aux touristes depuis des années. Nous comprenons qu'une voiture est plus qu'un véhicule ; c'est votre clé pour explorer de magnifiques paysages.",
        ...
        "why.title2": "le plus fiable de votre ville",
        ...
        "why.feat5.desc": "Nous sommes des locaux qui se soucient de votre expérience.",
        ...
        "footer.desc": "Votre partenaire fiable pour la location de voitures. Nous fournissons des véhicules de haute qualité et un service client exceptionnel 24h/24.",
    ...
    ar: {
        ...
        "about.p1": "نقدم حلول نقل موثوقة للسكان المحليين والسياح منذ سنوات. نحن نفهم أن السيارة أكثر من مجرد وسيلة نقل؛ إنها مفتاحك لاستكشاف المناظر الطبيعية الجميلة.",
        ...
        "why.title2": "الأكثر ثقة في مدينتك",
        ...
        "why.feat5.desc": "نحن محليون نهتم بتجربتك.",
        ...
        "footer.desc": "شريكك الموثوق لتأجير السيارات. نقدم سيارات عالية الجودة وخدمة عملاء استثنائية على مدار الساعة.",
